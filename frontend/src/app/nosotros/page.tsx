  ...
  return (
    <MarketingLayout>
      ...
      <SplitHero
        ...
        lead="SanitasSalud IPS nació para que cada paciente y su familia cuenten con un equipo médico especializado que los acompañe en cada etapa de su vida."
      ...
      <Section className="pt-0">
        <Reveal>
          <div className={`${container} max-w-3xl space-y-5 text-base leading-8 text-muted-foreground`}>
            <p>
              SanitasSalud IPS nació con el propósito de brindar una atención médica integral, oportuna y personalizada.
