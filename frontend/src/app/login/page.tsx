...
export const metadata: Metadata = { title: { absolute: "Iniciar sesión | CareNote" } };
...
const demoEmails: Record<string, string> = {
  superadmin: "superadmin@carenote.co",
  admin: "admin@carenote.co",
  enfermera: "enfermera@carenote.co",
  terapeuta: "terapeuta@carenote.co",
};
