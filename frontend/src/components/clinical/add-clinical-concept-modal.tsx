...
export function AddClinicalConceptModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl w-[94vw] max-h-[90vh] p-0 border-slate-200 bg-white text-slate-900 shadow-2xl overflow-hidden rounded-2xl flex flex-col">
        {/* Modal Header (Fixed) */}
        <div className="flex items-start justify-between border-b border-slate-100 bg-slate-50/80 p-5 sm:p-6 shrink-0">
        ...
        {/* Category Tabs Bar (Fixed) */}
        <div className="border-b border-slate-100 bg-slate-50/40 px-5 pt-4 shrink-0">
        ...
        {/* Modal Main Body (Flex-1 column with scrollable form content & fixed footer) */}
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0 overflow-hidden">
          ...
          <div className="shrink-0 border-t border-slate-100 p-4 sm:px-6 bg-slate-50/80 flex items-center justify-end gap-3">
            <Button
              type="button"
              variant="outline"
