        ...
        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl">
            <Reveal mount delay={0.25}>
              <p className="text-xs font-bold uppercase tracking-[0.28em] text-emerald-400">Escuela de Fútbol</p>
            ...
            <Reveal mount delay={0.38}>
              <p className="mt-6 max-w-md text-lg leading-8 text-white/85">
                Formación deportiva integral para niños y jóvenes de 5 a 18 años. Entrenadores certificados, metodología profesional y participación en torneos de liga.
              </p>
            </Reveal>
