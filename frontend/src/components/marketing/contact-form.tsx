...
export function ContactForm() {
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl bg-card p-6 shadow-elevation-3 sm:p-8">
      <LeadFields
        messagePlaceholder="Contanos en qué podemos ayudarte con la gestión de atenciones domiciliarias"
        secondaryField={{ placeholder: "Especialidad / IPS (opcional)", label: "Especialidad / IPS" }}
