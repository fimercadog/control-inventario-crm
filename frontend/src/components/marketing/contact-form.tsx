...
export function ContactForm() {
  ...
  return (
    <form onSubmit={submit} className="rounded-2xl bg-card p-6 shadow-elevation-3 sm:p-8">
      <LeadFields
        messagePlaceholder="Cuéntanos en qué podemos ayudarte con tu valoración o tratamiento"
        secondaryField={{ placeholder: "Tratamiento de interés (opcional)", label: "Tratamiento de interés" }}
      />
      {error ? (
