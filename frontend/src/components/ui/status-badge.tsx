...
export function getCategoryFromText(text: string): StatusCategory {
  ...
  // 2. Verde (Éxito / Pagado / Confirmado / Aceptado / Activo / Ganado / Disponible)
  if (
  ...
  // 3. Azul (Enviado / Emitido / Programado / Información / Sitio web / Arrendado)
  if (
  ...
  // 4. Ámbar / Amarillo (Pendiente / Parcial / Por revisar / Advertencia / Bajo stock / Reservado)
  if (
  ...
  // 6. Morado (Especial / IA / Premium / Vendido)
