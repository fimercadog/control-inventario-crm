...
/**
 * Diccionario maestro y estricto de estados técnicos del ERP Transversal e Inmobiliaria.
...
export const STATUS_DICTIONARY: Record<string, StatusDefinition> = {
  ...
  scheduled: { label: "Programado", category: "info", className: "bg-sky-200 text-zinc-950 border-none font-medium dark:bg-sky-800 dark:text-sky-100" },
  ...
  attended: { label: "Atendido", category: "success", className: "bg-emerald-200 text-zinc-950 border-none font-semibold dark:bg-emerald-800 dark:text-emerald-100" },
  no_show: { label: "No asistió", category: "warning", className: "bg-orange-200 text-zinc-950 border-none font-medium dark:bg-orange-800 dark:text-orange-100" },
...
export function getCategoryFromText(text: string): StatusCategory {
  ...
  if (norm.includes("ia") || norm.includes("premium") || norm.includes("automatizad") || norm.includes("vendido")) {
    return "purple";
  }
