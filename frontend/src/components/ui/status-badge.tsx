...
/**
 * Diccionario maestro y estricto de estados técnicos del ERP.
...
export function getCategoryFromText(text: string): StatusCategory {
  ...
  if (norm.includes("borrador") || norm.includes("intern") || norm.includes("manual") || norm.includes("sin dato")) {
    return "secondary";
  }
