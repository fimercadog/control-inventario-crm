...
export interface BadgeProps extends React.HTMLAttributes<HTMLSpanElement> {
  variant?: "default" | "secondary" | "success" | "warning" | "destructive" | "purple" | "outline";
}
  ...
  return (
    <span
      className={cn(
        ...
        variant === "purple" && "bg-purple-100 text-purple-800 dark:bg-purple-950/70 dark:text-purple-300",
