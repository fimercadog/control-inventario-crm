...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/app/citas", label: "Citas & Valoraciones", icon: CalendarClock, permissions: ["appointments.manage"] },
      { href: "/app/pacientes", label: "Pacientes Estéticos", icon: UserCheck, permissions: ["patients.manage"] },
      { href: "/app/consultas", label: "Ficha Estética & Sesiones", icon: FileText, permissions: ["medical_records.manage"] },
      { href: "/app/aplicaciones", label: "Aplicaciones & Dosis", icon: Syringe, permissions: ["vaccinations.manage"] },
      { href: "/app/proximas-sesiones", label: "Próximas Sesiones", icon: AlertTriangle, permissions: ["vaccinations.manage"] },
      { href: "/app/recetas", label: "Prescripciones & Recetas", icon: FileText, permissions: ["prescriptions.manage"] },
      { href: "/app/procedimientos", label: "Tratamientos & Protocolos", icon: ClipboardList, permissions: ["procedures.manage"] },
      { href: "/app/diagnosticos", label: "Diagnósticos Estéticos", icon: ListChecks, permissions: ["medical_records.manage"] },
      { href: "/app/reportes-clinicos", label: "Reportes Estéticos", icon: BarChart3, permissions: ["clinical_reports.view"] },
      { href: "/app/servicios", label: "Servicios & Catálogo", icon: Tag, permissions: ["services.manage"] },
      { href: "/app/especies", label: "Zonas & Especialidades", icon: Tags, permissions: ["services.manage"] },
    ],
  },
  {
    label: "CRM / Comercial",
    items: [
      ...
      { href: "/app/clientes", label: "Clientes / Pacientes", icon: Users, permissions: ["clients.manage"] },
      ...
      { href: "/app/deals", label: "Planes & Tratamientos", icon: Handshake, permissions: ["deals.manage"] },
  ...
  },
  {
    ...
    items: [
      { href: "/app/productos", label: "Productos & Insumos", icon: Package, permissions: ["products.manage"] },
      { href: "/app/categorias", label: "Categorías", icon: Tags, permissions: ["products.manage"] },
      ...
      { href: "/app/bodegas", label: "Bodegas / Depósitos", icon: Warehouse, permissions: ["warehouses.manage"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/app/ordenes-compra", label: "Órdenes de compra", icon: ShoppingCart, permissions: ["purchase_orders.manage"] },
      { href: "/app/recepciones-compra", label: "Recepciones", icon: ClipboardList, permissions: ["purchase_receipts.manage"] },
    ],
  },
  {
    label: "Gestión Financiera Interna",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/app/ia", label: "Asistente IA Estético", icon: Bot, premium: true },
    ],
  },
  {
    label: "Administración",
    items: [
      { href: "/app/auditoria", label: "Auditoría", icon: ClipboardList, permissions: ["audit.view"] },
