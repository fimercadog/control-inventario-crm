...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/app/vacunas", label: "Aplicaciones & Dosis", icon: Syringe, permissions: ["vaccinations.manage"] },
      { href: "/app/vacunas-pendientes", label: "Próximas Sesiones", icon: AlertTriangle, permissions: ["vaccinations.manage"] },
