...
const navGroups: NavGroup[] = [
  ...
  {
    label: "Escuela & Cantera",
    items: [
      { href: "/app/alumnos", label: "Alumnos / Deportistas", icon: Users, permissions: ["clients.manage"] },
      { href: "/app/categorias", label: "Categorías por Edad", icon: Layers, permissions: ["clients.manage"] },
      { href: "/app/inscripciones", label: "Inscripciones & Pensiones", icon: FileText, permissions: ["clients.manage"] },
      { href: "/app/asistencia", label: "Control de Asistencia", icon: ListChecks, permissions: ["clients.manage"] },
      { href: "/app/entrenamientos", label: "Agenda de Entrenamientos", icon: CalendarDays, permissions: ["clients.manage"] },
      { href: "/app/tienda-uniformes", label: "Uniformes e Indumentaria", icon: ShoppingCart, permissions: ["products.manage"] },
    ],
  },
  {
    label: "CRM & Acudientes",
    items: [
      { href: "/app/leads", label: "Solicitudes de Prueba (Leads)", icon: Inbox, permissions: ["leads.view"] },
      { href: "/app/clientes", label: "Acudientes / Padres", icon: Users, permissions: ["clients.manage"] },
      { href: "/app/contactos", label: "Contactos de Emergencia", icon: Contact2, permissions: ["clients.manage"] },
