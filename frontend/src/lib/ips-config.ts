...
export const IPS_CONFIG = {
  ...
  isDemoMode: true,
  demoNoticeText: "SanitasSalud IPS · Demostración del Sistema ERP y Gestión Clínica (Datos Configurables)",

  brand: {
    name: "SanitasSalud IPS",
    shortName: "SanitasSalud",
  ...
  contact: {
    ...
    email: "atencion.paciente@sanitassaludips.com",
  ...
  social: {
    linkedin: "https://linkedin.com/company/sanitassalud-ips",
    facebook: "https://facebook.com/sanitassaludips",
    whatsapp: "https://wa.me/573108902020?text=Hola,%20deseo%20solicitar%20una%20cita%20m%C3%A9dica%20en%20SanitasSalud%20IPS",
  },
