...
- Catalogo publico (sitio de marketing): catalogo navegable, ficha de producto y "Solicitar cotizacion" (carrito local) que entra al CRM como Cliente + Cotizacion en borrador (`source=catalog`)
- Auditoria
- Usuarios y roles
- Reportes
